...
const CommentCard = ({ index, leftVal, commentData }) => {
  ...
  const deleteComment = (e) => {
    ...
    axios
      ...
      .then(() => {
        e.target.removeAttribute("disabled"); // Corrected attribute name
  ...
  const LoadMoreRepliesButton = () => {
    ...
    let button = (
      <button
        ...
        className=" center text-dark-grey/90 p-2 px-3 hover:bg-grey/90 rounded-md flex items-center gap-2 underline"
      >
        Load More Replies
      </button>
    );
  ...
  return (
    ...
    >
      <div className="my-4 p-5 rounded-md border border-dark-grey/30">
        ...
        <div className="flex gap-4 items-center mt-3">
          {commentData.isReplyLoaded ? (
            <button
              onClick={hideReplies}
              className="text-dark-grey p-2 px-2 hover:bg-grey/70 rounded-md flex items-center gap-2"
            >
          ...
          {username == commented_by_username || username == blog_author ? (
            <button
              className="p-2 px-3 rounded-md border border-dark-grey/30 ml-auto hover:bg-red/30 hover:text-red flex items-center"
