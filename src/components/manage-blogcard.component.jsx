...
const BlogStats = ({ stats }) => {
  return (
    <div className="flex gap-2 max-lg:mb-5 max-lg:pb-3 border-dark-grey/30 max-lg:border-b">
        ...
        return !key.includes("parent") ? (
          <div
            ...
            className={
              ...
              (i != 0 ? "border-dark-grey/30 border-l " : "")
            }
          >
            <h1 className="text-xl lg:text-2xl mb-1 text-black ">
