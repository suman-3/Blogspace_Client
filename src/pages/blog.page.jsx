    ...
    axios
      ...
      .then(async ({ data: { blog } }) => {
        ...
        if (blog.tags && blog.tags.length > 0) {
          // Check if blog.tags is defined and not empty
          axios
        ...
        >
          ...
          <div className="max-w-[900px] center py-10 max-lg:px-[5vw]">
            ...
            <div className="mt-7">
              ...
              <div className="flex max-sm:flex-col justify-between my-5">
                <div className="flex gap-5 items-start">
                  <img
                    src={profile_img}
                    className="w-12 h-12 rounded-full border border-dark-grey/50"
                  />
            ...
            <div className="my-10 font-gelasio blog-page-content">
              {content[0] && content[0].blocks ? (
                content[0].blocks.map((block, i) => (
                  <div key={i} className="my-3 md:my-7">
            ...
            {similarBlogs != null && similarBlogs.length ? (
              <>
                <h1 className="text-2xl mt-10 mb-8 font-medium">
                  Similar Blogs :
                </h1>
