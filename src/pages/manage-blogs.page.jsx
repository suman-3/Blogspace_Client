...
import { LoadMoreWhiteDataBtn } from "../components/load-more.component";
...
const ManageBlogs = () => {
    ...
    axios
      ...
      .then(async ({ data }) => {
        let formatedData = await FilterPaginationData({
          ...
          page,
          user: access_token,
          counteRoute: "/user-written-blog-count",
  ...
  return (
    <>
      ...
      <div className="relative mt-5 md:mt-7 mb-9">
        <input
          type="search"
          className="bg-grey w-full p-4 pl-12 pr-6 rounded-full placeholder:text-dark-grey"
