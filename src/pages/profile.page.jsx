      ...
      {loading ? (
        ...
        <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12">
          <div className="flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-l border-grey md:sticky md:top-[100px] md:py-8">
            <img
              src={profile_img}
              className="w-48 h-48 bg-grey rounded-full border md:w-32 md:h-32"
            />

            <h1 className="text-2xl font-medium">@{profile_username}</h1>

            <p className="text-xl capitalize h-5">{fullname}</p>

            <p>
              {Math.max(total_posts, 0).toLocaleString()} Blogs -{" "}
