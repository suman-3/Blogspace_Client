...
const PageNotFound = () => {
  ...
  return (
    <section className="h-cover relative p-10 flex flex-col items-center gap-20 text-center">
      ...
      />
      <h1 className="text-4xl font-gelasio leading-7 -mt-6">Page Not Found</h1>
      <p className="text-dark-grey text-xl left-7 -mt-8">
        The page are looking for does not exists. Head back to the
