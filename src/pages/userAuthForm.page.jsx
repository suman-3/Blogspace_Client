...
const UserAuthForm = ({ type }) => {
  ...
  const handleGoogleAuth = (e) => {
    ...
    authWithGoogle()
      ...
      .catch((err) => {
        toast.error("Trouble while login with Google!");
    ...
    <AnimationWrapper keyValue={type}>
      <section className="h-cover flex items-center justify-center ">
        ...
        >
          ...
          <button
            className="btn-dark center mt-9 w-full rounded-md"
            type="submit"
          ...
          <button
            className="btn-dark flex items-center justify-center gap-3 center w-full rounded-md"
